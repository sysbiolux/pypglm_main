...
elseif Model_Example == 4
    InputFile=[FALCONFolder filesep 'ExampleDatasets' filesep 'Greta' filesep 'crosstalk_model_final.xlsx'];
...
[MeanStateValueAll, StdStateValueAll, MeanCostAll, StdCostAll, estim] = FalconSimul(estim,param_test,[PlotFitSummary PlotFitIndividual PlotHeatmapCost PlotStateSummary PlotStateEvolution],FinalFolderName);
